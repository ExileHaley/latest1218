...
contract LiquidityManager is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuard, ILiquidityManager{
    ...
    function acquireSpecifiedUsdt(address to, uint256 needUSDT) external onlyStaking {
        ...
        TransferHelper.safeTransfer(USDT, recipientForBurn, 5e18);
        // _burnSubToken(5e18);
    }
